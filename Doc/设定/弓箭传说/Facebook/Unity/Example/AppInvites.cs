    ...
    internal class AppInvites : MenuBase
    {
        protected override void GetGui()
        {
            if (base.Button("Android Invite"))
            {
                ...
                FB.Mobile.AppInvite(new Uri("https://fb.me/892708710750483"), null, new FacebookDelegate<IAppInviteResult>(this.HandleResult));
            }
            ...
            {
                base.Status = "Logged FB.AppEvent";
                FB.Mobile.AppInvite(new Uri("https://fb.me/810530068992919"), null, new FacebookDelegate<IAppInviteResult>(this.HandleResult));
            }
