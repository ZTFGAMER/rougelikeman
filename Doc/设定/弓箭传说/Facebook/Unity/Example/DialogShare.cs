namespace Facebook.Unity.Example
{
    ...
    internal class DialogShare : MenuBase
    {
        ...
        protected override void GetGui()
        {
            ...
            {
                FB.ShareLink(new Uri("https://developers.facebook.com/"), string.Empty, string.Empty, null, new FacebookDelegate<IShareResult>(this.HandleResult));
            }
            ...
            GUI.set_enabled(flag && (!Constants.IsEditor || (Constants.IsEditor && FB.IsLoggedIn)));
