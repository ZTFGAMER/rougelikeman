...
public class MainUIPage3 : UIBase
{
    ...
    public MainUIPage3(Transform parent) : base(parent)
    {
    }
    ...
    {
        base.mView = Object.Instantiate<GameObject>(ResourceManager.Load<GameObject>("UIPanel/MainUI/3Card"));
    ...
    {
        this.child = new GameObject("3_card");
