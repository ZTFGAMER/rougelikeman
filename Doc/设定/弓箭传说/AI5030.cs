...
public class AI5030 : AIBase
{
    ...
    protected override void OnInit()
    {
        ...
        action.AddAction(20, this.GetActionSequence(0x13ca, 0x7d0, 0x3e8));
        action.AddAction(20, this.GetActionSequence(0x13cb, 0x7d0, 0x3e8));
        action.AddAction(20, this.GetActionSequence(0x13cc, 0x9c4, 0x3e8));
        action.AddAction(20, this.GetActionSequence(0x13cd, 0x9c4, 0x3e8));
