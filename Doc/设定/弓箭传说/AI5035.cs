...
public class AI5035 : AIBase
{
    ...
    protected override void OnInit()
    {
        ...
        {
            case 0:
                base.AddAction(this.GetActionSequence(0x13ed, 0x7d0, 0x3e8));
                break;

            case 1:
                base.AddAction(this.GetActionSequence(0x13ef, 0x7d0, 0x3e8));
                break;

            case 2:
                base.AddAction(this.GetActionSequence(0x13f0, 0x7d0, 0x3e8));
                break;
        }
        base.bReRandom = true;
    }
