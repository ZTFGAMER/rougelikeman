namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    ...
    internal class SecT283K1Point : AbstractF2mPoint
    {
        ...
        protected override ECPoint Detach() => 
            new SecT283K1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT283K1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (element5.IsZero)
            {
                return new SecT283K1Point(curve, element5, curve.B, base.IsCompressed);
            }
            ...
            return new SecT283K1Point(curve, element6, y, new ECFieldElement[] { element7 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT283K1Point(curve, element16, element18, new ECFieldElement[] { element17 }, base.IsCompressed);
        }
