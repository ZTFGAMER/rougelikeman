    ...
    internal class SecT409K1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            if (element2.IsZero)
            {
                ...
                if (element13.IsZero)
                {
                    return new SecT409K1Point(curve, element13, curve.B, base.IsCompressed);
                }
            ...
            return new SecT409K1Point(curve, element13, element14, new ECFieldElement[] { element15 }, base.IsCompressed);
        }

        protected override ECPoint Detach() => 
            new SecT409K1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT409K1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (element5.IsZero)
            {
                return new SecT409K1Point(curve, element5, curve.B, base.IsCompressed);
            }
            ...
            return new SecT409K1Point(curve, element6, y, new ECFieldElement[] { element7 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT409K1Point(curve, element16, element18, new ECFieldElement[] { element17 }, base.IsCompressed);
        }
