    ...
    internal class SecT233R1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            if (element2.IsZero)
            {
                ...
                if (element13.IsZero)
                {
                    return new SecT233R1Point(curve, element13, curve.B.Sqrt(), base.IsCompressed);
                }
            ...
            return new SecT233R1Point(curve, element13, element14, new ECFieldElement[] { element15 }, base.IsCompressed);
        }

        protected override ECPoint Detach() => 
            new SecT233R1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT233R1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (x.IsZero)
            {
                return new SecT233R1Point(curve, x, curve.B.Sqrt(), base.IsCompressed);
            }
            ...
            return new SecT233R1Point(curve, element7, y, new ECFieldElement[] { element8 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT233R1Point(curve, element16, element18, new ECFieldElement[] { element17 }, base.IsCompressed);
        }
