namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    ...
    internal class SecT233K1Point : AbstractF2mPoint
    {
        ...
        protected override ECPoint Detach() => 
            new SecT233K1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT233K1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (element5.IsZero)
            {
                return new SecT233K1Point(curve, element5, curve.B, base.IsCompressed);
            }
            ...
            return new SecT233K1Point(curve, element6, y, new ECFieldElement[] { element7 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT233K1Point(curve, element16, element18, new ECFieldElement[] { element17 }, base.IsCompressed);
        }
