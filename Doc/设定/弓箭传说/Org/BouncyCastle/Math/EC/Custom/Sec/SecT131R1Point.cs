    ...
    internal class SecT131R1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            if (element2.IsZero)
            {
                ...
                if (element13.IsZero)
                {
                    return new SecT131R1Point(curve, element13, curve.B.Sqrt(), base.IsCompressed);
                }
            ...
            return new SecT131R1Point(curve, element13, element14, new ECFieldElement[] { element15 }, base.IsCompressed);
        }

        protected override ECPoint Detach() => 
            new SecT131R1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT131R1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (x.IsZero)
            {
                return new SecT131R1Point(curve, x, curve.B.Sqrt(), base.IsCompressed);
            }
            ...
            return new SecT131R1Point(curve, element9, y, new ECFieldElement[] { element10 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT131R1Point(curve, element16, element18, new ECFieldElement[] { y }, base.IsCompressed);
        }
