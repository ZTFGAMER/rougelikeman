namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    ...
    internal class SecT283R1Point : AbstractF2mPoint
    {
        ...
        protected override ECPoint Detach() => 
            new SecT283R1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT283R1Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (x.IsZero)
            {
                return new SecT283R1Point(curve, x, curve.B.Sqrt(), base.IsCompressed);
            }
            ...
            return new SecT283R1Point(curve, element7, y, new ECFieldElement[] { element8 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT283R1Point(curve, element16, element18, new ECFieldElement[] { element17 }, base.IsCompressed);
        }
