namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    ...
    internal class SecT193R2Point : AbstractF2mPoint
    {
        ...
        protected override ECPoint Detach() => 
            new SecT193R2Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecT193R2Point(this.Curve, rawXCoord, rawYCoord.Add(b), new ECFieldElement[] { b }, base.IsCompressed);
        }
        ...
        public override ECPoint Twice()
        {
            ...
            if (x.IsZero)
            {
                return new SecT193R2Point(curve, x, curve.B.Sqrt(), base.IsCompressed);
            }
            ...
            return new SecT193R2Point(curve, element9, y, new ECFieldElement[] { element10 }, base.IsCompressed);
        }
        ...
        public override ECPoint TwicePlus(ECPoint b)
        {
            ...
            return new SecT193R2Point(curve, element16, element18, new ECFieldElement[] { y }, base.IsCompressed);
        }
