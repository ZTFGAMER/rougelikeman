namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    ...
    internal class SecP160K1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            return new SecP160K1Point(curve, element7, y, zs, base.IsCompressed);
        }

        protected override ECPoint Detach() => 
            new SecP160K1Point(null, this.AffineXCoord, this.AffineYCoord);
        ...
        public override ECPoint Twice()
        {
            ...
            uint[] z = Nat160.Create();
            SecP160R2Field.Square(rawYCoord.x, z);
            uint[] numArray2 = Nat160.Create();
            SecP160R2Field.Square(z, numArray2);
            uint[] numArray3 = Nat160.Create();
            ...
            uint[] numArray4 = z;
            SecP160R2Field.Multiply(z, rawXCoord.x, numArray4);
            SecP160R2Field.Reduce32(Nat.ShiftUpBits(5, numArray4, 2, 0), numArray4);
            uint[] numArray5 = Nat160.Create();
            SecP160R2Field.Reduce32(Nat.ShiftUpBits(5, numArray2, 3, 0, numArray5), numArray5);
            ...
            SecP160R2FieldElement element6 = new SecP160R2FieldElement(numArray3);
            SecP160R2Field.Twice(rawYCoord.x, element6.x);
            if (!element3.IsOne)
            {
                SecP160R2Field.Multiply(element6.x, element3.x, element6.x);
            }
            return new SecP160K1Point(curve, x, y, new ECFieldElement[] { element6 }, base.IsCompressed);
        }
