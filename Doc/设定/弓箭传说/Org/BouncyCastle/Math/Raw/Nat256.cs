namespace Org.BouncyCastle.Math.Raw
{
    ...
    internal abstract class Nat256
    {
        ...
        public static uint AddBothTo(uint[] x, int xOff, uint[] y, int yOff, uint[] z, int zOff)
        {
            ...
            z[zOff + 6] = (uint) num;
            num = num >> 0x20;
            num += (x[xOff + 7] + y[yOff + 7]) + z[zOff + 7];
            z[zOff + 7] = (uint) num;
            num = num >> 0x20;
            return (uint) num;
        }
        ...
        {
            if ((x.SignValue < 0) || (x.BitLength > 0x100))
            {
        ...
        public static void Mul(uint[] x, uint[] y, uint[] zz)
        {
            ...
            for (int i = 1; i < 8; i++)
            {
                ulong num12 = 0L;
                ulong num13 = x[i];
                num12 += (num13 * num) + zz[i];
                zz[i] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num2) + zz[i + 1];
                zz[i + 1] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num3) + zz[i + 2];
                zz[i + 2] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num4) + zz[i + 3];
                zz[i + 3] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num5) + zz[i + 4];
                zz[i + 4] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num6) + zz[i + 5];
                zz[i + 5] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num7) + zz[i + 6];
                zz[i + 6] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num8) + zz[i + 7];
                zz[i + 7] = (uint) num12;
                num12 = num12 >> 0x20;
                zz[i + 8] = (uint) num12;
            }
        ...
        public static void Mul(uint[] x, int xOff, uint[] y, int yOff, uint[] zz, int zzOff)
        {
            ...
            for (int i = 1; i < 8; i++)
            {
                zzOff++;
                ulong num12 = 0L;
                ulong num13 = x[xOff + i];
                num12 += (num13 * num) + zz[zzOff];
                zz[zzOff] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num2) + zz[zzOff + 1];
                zz[zzOff + 1] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num3) + zz[zzOff + 2];
                zz[zzOff + 2] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num4) + zz[zzOff + 3];
                zz[zzOff + 3] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num5) + zz[zzOff + 4];
                zz[zzOff + 4] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num6) + zz[zzOff + 5];
                zz[zzOff + 5] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num7) + zz[zzOff + 6];
                zz[zzOff + 6] = (uint) num12;
                num12 = num12 >> 0x20;
                num12 += (num13 * num8) + zz[zzOff + 7];
                zz[zzOff + 7] = (uint) num12;
                num12 = num12 >> 0x20;
                zz[zzOff + 8] = (uint) num12;
            }
        }
        ...
        public static void Square(uint[] x, uint[] zz)
        {
            ...
            zz[7] = (num4 << 1) | num3;
            num3 = num4 >> 0x1f;
            num20 += (num19 >> 0x20) + (num27 * num10);
            num22 += (num20 >> 0x20) + (num27 * num12);
            num23 += (num22 >> 0x20) + (num27 * num15);
            num25 += (num23 >> 0x20) + (num27 * num18);
            num26 += (num25 >> 0x20) + (num27 * num21);
            num28 += (num26 >> 0x20) + (num27 * num24);
            num29 += num28 >> 0x20;
            num4 = (uint) num20;
            zz[8] = (num4 << 1) | num3;
            num3 = num4 >> 0x1f;
        ...
        public static void Square(uint[] x, int xOff, uint[] zz, int zzOff)
        {
            ...
            num3 = num4 >> 0x1f;
            num4 = (uint) num29;
            zz[zzOff + 14] = (num4 << 1) | num3;
            num3 = num4 >> 0x1f;
            num4 = zz[zzOff + 15] + ((uint) (num29 >> 0x20));
            zz[zzOff + 15] = (num4 << 1) | num3;
        }
        ...
        public static int Sub(uint[] x, int xOff, uint[] y, int yOff, uint[] z, int zOff)
        {
            ...
            z[zOff + 6] = (uint) num;
            num = num >> 0x20;
            num = (long) (((ulong) num) + (x[xOff + 7] - y[yOff + 7]));
            z[zOff + 7] = (uint) num;
            num = num >> 0x20;
            return (int) num;
        }
        ...
        public static int SubBothFrom(uint[] x, uint[] y, uint[] z)
        {
            ...
            z[6] = (uint) num;
            num = num >> 0x20;
            num = (long) (((ulong) num) + ((z[7] - x[7]) - y[7]));
            z[7] = (uint) num;
            num = num >> 0x20;
            return (int) num;
        }
        ...
        public static int SubFrom(uint[] x, int xOff, uint[] z, int zOff)
        {
            ...
            z[zOff + 6] = (uint) num;
            num = num >> 0x20;
            num = (long) (((ulong) num) + (z[zOff + 7] - x[xOff + 7]));
            z[zOff + 7] = (uint) num;
            num = num >> 0x20;
            return (int) num;
        }
