namespace Org.BouncyCastle.Crypto.Operators
{
    ...
    internal class X509Utilities
    {
        ...
        static X509Utilities()
        {
            ...
            AlgorithmIdentifier identifier2 = new AlgorithmIdentifier(NistObjectIdentifiers.IdSha224, DerNull.Instance);
            exParams.Add("SHA224WITHRSAANDMGF1", CreatePssParams(identifier2, 0x1c));
            AlgorithmIdentifier identifier3 = new AlgorithmIdentifier(NistObjectIdentifiers.IdSha256, DerNull.Instance);
            exParams.Add("SHA256WITHRSAANDMGF1", CreatePssParams(identifier3, 0x20));
            AlgorithmIdentifier identifier4 = new AlgorithmIdentifier(NistObjectIdentifiers.IdSha384, DerNull.Instance);
            exParams.Add("SHA384WITHRSAANDMGF1", CreatePssParams(identifier4, 0x30));
            AlgorithmIdentifier identifier5 = new AlgorithmIdentifier(NistObjectIdentifiers.IdSha512, DerNull.Instance);
            exParams.Add("SHA512WITHRSAANDMGF1", CreatePssParams(identifier5, 0x40));
        }

        private static RsassaPssParameters CreatePssParams(AlgorithmIdentifier hashAlgId, int saltSize) => 
            new RsassaPssParameters(hashAlgId, new AlgorithmIdentifier(PkcsObjectIdentifiers.IdMgf1, hashAlgId), new DerInteger(saltSize), new DerInteger(1));

        internal static IEnumerable GetAlgNames() => 
            new EnumerableProxy(algorithms.Keys);
