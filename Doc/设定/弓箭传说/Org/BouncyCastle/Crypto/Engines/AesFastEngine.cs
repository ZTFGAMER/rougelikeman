namespace Org.BouncyCastle.Crypto.Engines
{
    ...
    public class AesFastEngine : IBlockCipher
    {
        ...
        private static readonly uint[] T1 = new uint[] { 
            ...
            0x5353a6f5, 0xd1d1b968, 0, 0xededc12c, 0x20204060, 0xfcfce31f, 0xb1b179c8, 0x5b5bb6ed, 0x6a6ad4be, 0xcbcb8d46, 0xbebe67d9, 0x3939724b, 0x4a4a94de, 0x4c4c98d4, 0x5858b0e8, 0xcfcf854a,
        ...
        private static readonly uint[] T2 = new uint[] { 
            ...
            0x53a6f553, 0xd1b968d1, 0, 0xedc12ced, 0x20406020, 0xfce31ffc, 0xb179c8b1, 0x5bb6ed5b, 0x6ad4be6a, 0xcb8d46cb, 0xbe67d9be, 0x39724b39, 0x4a94de4a, 0x4c98d44c, 0x58b0e858, 0xcf854acf,
        ...
        private static readonly uint[] T3 = new uint[] { 
            ...
            0xa6f55353, 0xb968d1d1, 0, 0xc12ceded, 0x40602020, 0xe31ffcfc, 0x79c8b1b1, 0xb6ed5b5b, 0xd4be6a6a, 0x8d46cbcb, 0x67d9bebe, 0x724b3939, 0x94de4a4a, 0x98d44c4c, 0xb0e85858, 0x854acfcf,
        ...
        private static readonly uint[] Tinv1 = new uint[] { 
            ...
            0xa7ca147, 0xf427ce9, 0x1e84f8c9, 0, 0x86800983, 0xed2b3248, 0x70111eac, 0x725a6c4e, 0xff0efdfb, 0x38850f56, 0xd5ae3d1e, 0x392d3627, 0xd90f0a64, 0xa65c6821, 0x545b9bd1, 0x2e36243a,
        ...
        private static readonly uint[] Tinv2 = new uint[] { 
            ...
            0x7ca1470a, 0x427ce90f, 0x84f8c91e, 0, 0x80098386, 0x2b3248ed, 0x111eac70, 0x5a6c4e72, 0xefdfbff, 0x850f5638, 0xae3d1ed5, 0x2d362739, 0xf0a64d9, 0x5c6821a6, 0x5b9bd154, 0x36243a2e,
        ...
        private static readonly uint[] Tinv3 = new uint[] { 
            ...
            0xa1470a7c, 0x7ce90f42, 0xf8c91e84, 0, 0x9838680, 0x3248ed2b, 0x1eac7011, 0x6c4e725a, 0xfdfbff0e, 0xf563885, 0x3d1ed5ae, 0x3627392d, 0xa64d90f, 0x6821a65c, 0x9bd1545b, 0x243a2e36,
        ...
        private void DecryptBlock(uint[][] KW)
        {
            ...
            {
                numArray = KW[num8--];
                num4 = (((Tinv0[(int) ((IntPtr) (num & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num7 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num3 >> 0x10) & 0xff))]) ^ Tinv3[num2 >> 0x18]) ^ numArray[0];
                num5 = (((Tinv0[(int) ((IntPtr) (num2 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ Tinv3[num3 >> 0x18]) ^ numArray[1];
                num6 = (((Tinv0[(int) ((IntPtr) (num3 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num2 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num >> 0x10) & 0xff))]) ^ Tinv3[num7 >> 0x18]) ^ numArray[2];
                num7 = (((Tinv0[(int) ((IntPtr) (num7 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num3 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num2 >> 0x10) & 0xff))]) ^ Tinv3[num >> 0x18]) ^ numArray[3];
                numArray = KW[num8--];
                num = (((Tinv0[(int) ((IntPtr) (num4 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num7 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num6 >> 0x10) & 0xff))]) ^ Tinv3[num5 >> 0x18]) ^ numArray[0];
                num2 = (((Tinv0[(int) ((IntPtr) (num5 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num4 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ Tinv3[num6 >> 0x18]) ^ numArray[1];
                num3 = (((Tinv0[(int) ((IntPtr) (num6 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num5 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num4 >> 0x10) & 0xff))]) ^ Tinv3[num7 >> 0x18]) ^ numArray[2];
                num7 = (((Tinv0[(int) ((IntPtr) (num7 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num6 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num5 >> 0x10) & 0xff))]) ^ Tinv3[num4 >> 0x18]) ^ numArray[3];
            }
            numArray = KW[1];
            num4 = (((Tinv0[(int) ((IntPtr) (num & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num7 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num3 >> 0x10) & 0xff))]) ^ Tinv3[num2 >> 0x18]) ^ numArray[0];
            num5 = (((Tinv0[(int) ((IntPtr) (num2 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ Tinv3[num3 >> 0x18]) ^ numArray[1];
            ...
            num7 = (((Tinv0[(int) ((IntPtr) (num7 & 0xff))] ^ Tinv1[(int) ((IntPtr) ((num3 >> 8) & 0xff))]) ^ Tinv2[(int) ((IntPtr) ((num2 >> 0x10) & 0xff))]) ^ Tinv3[num >> 0x18]) ^ numArray[3];
            numArray = KW[0];
            this.C0 = ((uint) (((Si[(int) ((IntPtr) (num4 & 0xff))] ^ (Si[(int) ((IntPtr) ((num7 >> 8) & 0xff))] << 8)) ^ (Si[(int) ((IntPtr) ((num6 >> 0x10) & 0xff))] << 0x10)) ^ (Si[num5 >> 0x18] << 0x18))) ^ numArray[0];
            this.C1 = ((uint) (((Si[(int) ((IntPtr) (num5 & 0xff))] ^ (Si[(int) ((IntPtr) ((num4 >> 8) & 0xff))] << 8)) ^ (Si[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))] << 0x10)) ^ (Si[num6 >> 0x18] << 0x18))) ^ numArray[1];
            this.C2 = ((uint) (((Si[(int) ((IntPtr) (num6 & 0xff))] ^ (Si[(int) ((IntPtr) ((num5 >> 8) & 0xff))] << 8)) ^ (Si[(int) ((IntPtr) ((num4 >> 0x10) & 0xff))] << 0x10)) ^ (Si[num7 >> 0x18] << 0x18))) ^ numArray[2];
            this.C3 = ((uint) (((Si[(int) ((IntPtr) (num7 & 0xff))] ^ (Si[(int) ((IntPtr) ((num6 >> 8) & 0xff))] << 8)) ^ (Si[(int) ((IntPtr) ((num5 >> 0x10) & 0xff))] << 0x10)) ^ (Si[num4 >> 0x18] << 0x18))) ^ numArray[3];
        }
        ...
        private void EncryptBlock(uint[][] KW)
        {
            ...
            {
                numArray = KW[index++];
                num4 = (((T0[(int) ((IntPtr) (num & 0xff))] ^ T1[(int) ((IntPtr) ((num2 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num3 >> 0x10) & 0xff))]) ^ T3[num7 >> 0x18]) ^ numArray[0];
                num5 = (((T0[(int) ((IntPtr) (num2 & 0xff))] ^ T1[(int) ((IntPtr) ((num3 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ T3[num >> 0x18]) ^ numArray[1];
                num6 = (((T0[(int) ((IntPtr) (num3 & 0xff))] ^ T1[(int) ((IntPtr) ((num7 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num >> 0x10) & 0xff))]) ^ T3[num2 >> 0x18]) ^ numArray[2];
                num7 = (((T0[(int) ((IntPtr) (num7 & 0xff))] ^ T1[(int) ((IntPtr) ((num >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num2 >> 0x10) & 0xff))]) ^ T3[num3 >> 0x18]) ^ numArray[3];
                numArray = KW[index++];
                num = (((T0[(int) ((IntPtr) (num4 & 0xff))] ^ T1[(int) ((IntPtr) ((num5 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num6 >> 0x10) & 0xff))]) ^ T3[num7 >> 0x18]) ^ numArray[0];
                num2 = (((T0[(int) ((IntPtr) (num5 & 0xff))] ^ T1[(int) ((IntPtr) ((num6 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ T3[num4 >> 0x18]) ^ numArray[1];
                num3 = (((T0[(int) ((IntPtr) (num6 & 0xff))] ^ T1[(int) ((IntPtr) ((num7 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num4 >> 0x10) & 0xff))]) ^ T3[num5 >> 0x18]) ^ numArray[2];
                num7 = (((T0[(int) ((IntPtr) (num7 & 0xff))] ^ T1[(int) ((IntPtr) ((num4 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num5 >> 0x10) & 0xff))]) ^ T3[num6 >> 0x18]) ^ numArray[3];
            }
            numArray = KW[index++];
            num4 = (((T0[(int) ((IntPtr) (num & 0xff))] ^ T1[(int) ((IntPtr) ((num2 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num3 >> 0x10) & 0xff))]) ^ T3[num7 >> 0x18]) ^ numArray[0];
            num5 = (((T0[(int) ((IntPtr) (num2 & 0xff))] ^ T1[(int) ((IntPtr) ((num3 >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))]) ^ T3[num >> 0x18]) ^ numArray[1];
            ...
            num7 = (((T0[(int) ((IntPtr) (num7 & 0xff))] ^ T1[(int) ((IntPtr) ((num >> 8) & 0xff))]) ^ T2[(int) ((IntPtr) ((num2 >> 0x10) & 0xff))]) ^ T3[num3 >> 0x18]) ^ numArray[3];
            numArray = KW[index];
            this.C0 = ((uint) (((S[(int) ((IntPtr) (num4 & 0xff))] ^ (S[(int) ((IntPtr) ((num5 >> 8) & 0xff))] << 8)) ^ (S[(int) ((IntPtr) ((num6 >> 0x10) & 0xff))] << 0x10)) ^ (S[num7 >> 0x18] << 0x18))) ^ numArray[0];
            this.C1 = ((uint) (((S[(int) ((IntPtr) (num5 & 0xff))] ^ (S[(int) ((IntPtr) ((num6 >> 8) & 0xff))] << 8)) ^ (S[(int) ((IntPtr) ((num7 >> 0x10) & 0xff))] << 0x10)) ^ (S[num4 >> 0x18] << 0x18))) ^ numArray[1];
            this.C2 = ((uint) (((S[(int) ((IntPtr) (num6 & 0xff))] ^ (S[(int) ((IntPtr) ((num7 >> 8) & 0xff))] << 8)) ^ (S[(int) ((IntPtr) ((num4 >> 0x10) & 0xff))] << 0x10)) ^ (S[num5 >> 0x18] << 0x18))) ^ numArray[2];
            this.C3 = ((uint) (((S[(int) ((IntPtr) (num7 & 0xff))] ^ (S[(int) ((IntPtr) ((num4 >> 8) & 0xff))] << 8)) ^ (S[(int) ((IntPtr) ((num5 >> 0x10) & 0xff))] << 0x10)) ^ (S[num6 >> 0x18] << 0x18))) ^ numArray[3];
        }
