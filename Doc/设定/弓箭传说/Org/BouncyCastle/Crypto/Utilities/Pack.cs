namespace Org.BouncyCastle.Crypto.Utilities
{
    ...
    internal sealed class Pack
    {
        ...
        internal static uint BE_To_UInt32(byte[] bs) => 
            ((uint) ((((bs[0] << 0x18) | (bs[1] << 0x10)) | (bs[2] << 8)) | bs[3]));

        internal static uint BE_To_UInt32(byte[] bs, int off) => 
            ((uint) ((((bs[off] << 0x18) | (bs[off + 1] << 0x10)) | (bs[off + 2] << 8)) | bs[off + 3]));
        ...
        internal static uint LE_To_UInt32(byte[] bs) => 
            ((uint) (((bs[0] | (bs[1] << 8)) | (bs[2] << 0x10)) | (bs[3] << 0x18)));

        internal static uint LE_To_UInt32(byte[] bs, int off) => 
            ((uint) (((bs[off] | (bs[off + 1] << 8)) | (bs[off + 2] << 0x10)) | (bs[off + 3] << 0x18)));
        ...
        internal static uint[] LE_To_UInt32(byte[] bs, int off, int count)
        {
            ...
            {
                numArray[i] = LE_To_UInt32(bs, off);
                off += 4;
            }
            return numArray;
        }
        ...
        internal static void UInt32_To_LE(uint n, byte[] bs, int off)
        {
            bs[off] = (byte) n;
            bs[off + 1] = (byte) (n >> 8);
            bs[off + 2] = (byte) (n >> 0x10);
            bs[off + 3] = (byte) (n >> 0x18);
        }
