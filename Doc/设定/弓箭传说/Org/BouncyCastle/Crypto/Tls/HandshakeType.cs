namespace Org.BouncyCastle.Crypto.Tls
{
    ...
    public abstract class HandshakeType
    {
        ...
        public const byte client_key_exchange = 0x10;
        public const byte finished = 20;
        public const byte certificate_url = 0x15;
        public const byte certificate_status = 0x16;
        public const byte hello_verify_request = 3;
        public const byte supplemental_data = 0x17;
