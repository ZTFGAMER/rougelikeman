...
public class Weapon5127 : WeaponBase
{
    ...
    protected override void OnAttack(object[] args)
    {
        ...
        base.action.AddActionDelegate(() => Updater.RemoveUpdate("Weapon5127", new Action<float>(this.OnUpdate)));
    }

    protected override void OnInstall()
    {
        Updater.AddUpdate("Weapon5127", new Action<float>(this.OnUpdate), false);
    }

    protected override void OnUnInstall()
    {
        Updater.RemoveUpdate("Weapon5127", new Action<float>(this.OnUpdate));
    }
