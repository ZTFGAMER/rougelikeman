namespace GooglePlayGames.OurUtils
{
    ...
    public class Logger
    {
        ...
        private sealed class <d>c__AnonStorey0
        {
            ...
            internal void <>m__0()
            {
                Debug.Log(GooglePlayGames.OurUtils.Logger.ToLogMessage(string.Empty, "DEBUG", this.msg));
            }
        }
        ...
        private sealed class <e>c__AnonStorey2
        {
            ...
            internal void <>m__0()
            {
                Debug.LogWarning(GooglePlayGames.OurUtils.Logger.ToLogMessage("***", "ERROR", this.msg));
            }
        }
        ...
        private sealed class <w>c__AnonStorey1
        {
            ...
            internal void <>m__0()
            {
                Debug.LogWarning(GooglePlayGames.OurUtils.Logger.ToLogMessage("!!!", "WARNING", this.msg));
            }
        }
    }
}
