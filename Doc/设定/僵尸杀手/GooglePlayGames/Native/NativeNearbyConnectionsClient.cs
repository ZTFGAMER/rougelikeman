namespace GooglePlayGames.Native
{
    ...
    internal class NativeNearbyConnectionsClient : INearbyConnectionClient
    {
        ...
        public void StartAdvertising(string name, List<string> appIdentifiers, TimeSpan? advertisingDuration, Action<AdvertisingResult> resultCallback, Action<ConnectionRequest> requestCallback)
        {
            ...
            this.mManager.StartAdvertising(name, Enumerable.Select<string, NativeAppIdentifier>(appIdentifiers, <>f__mg$cache0).ToList<NativeAppIdentifier>(), ToTimeoutMillis(advertisingDuration), new Action<long, NativeStartAdvertisingResult>(storey.<>m__0), new Action<long, NativeConnectionRequest>(storey.<>m__1));
        }
